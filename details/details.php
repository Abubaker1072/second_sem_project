...
<body>
    <header class="navbar">
      ...
      <div class="container">
        ...
        <div class="columns">
            <ul class="price">
              <li class="pricetitles">Standerd</li>
              <li class="grey">300$ </li>
              <li>Shoots</li>
              <li>2days</li>
              <li>Rides</li>
              <li>Lunch/dinner</li>
              <li class="grey"><a href="/booking page/booking.php" class="button">Book Now</a></li>
              <li><input type="checkbox" name="" id="">Verify it</li>
            </ul>
          </div>
          <div class="columns">
            <ul class="price">
              <li class="pricetitles">Intermediate</li>
              <li class="grey">500$</li>
              <li>Shoot</li>
              <li>4days</li>
              <li>Rides Activities</li>
        ...
        <div class="columns">
        <ul class="price">
          <li class="pricetitles">Premium</li>
          <li class="grey">900$</li>
          <li>shoot</li>
          <li>6 days</li>
          <li>activites +no extra xharges</li>
          <li>Breaskfast/lunch/dinner/snacks</li>
          <li class="grey" ><a href="/booking page/booking.php" class="button">Book Now</a></li>
          <li><input type="checkbox" name="" id="">Verify it</li>
        </ul>
        </div>
    ...
    <div class="table-container">
        <table class="tour-table">
            ...
            <tbody>
                <tr>
                    <td>SAM</td>
                    <td>FIRST 5 DAYS OF MONTH</td>
                    <td>$50</td>
                    <td><a href="/booking page/booking.php">View Plan</a></td>
                    <td>75%</td>
                    <td><a href="">Portfolio Link</a></td>
                </tr>
                <tr>
                    <td>mike</td>
                    <td>5-10 days</td>
    ...
    <br>
<!--.......................................-->
<h4 id="ser1" >SERVICES:</h4>
<div class="table-container">
    <table class="tour-table">
        <thead>
            <tr>
                <th>Agent/Photographer Charges</th>
                <th>Checkin</th>
                <th>Travel</th>
                <th>Customized Tour Plan</th>
                <th>Shoots</th>
                <th>Lunch/breadkfast/dinner</th>
            </tr>
        </thead>
        <tbody>
            <tr>
          ...
          <div class="footer-columns">
            <div class="footer-column">
              ...
              <ul>
                ...
                <li><a href="signup.php">detail</a></li>
